...
export const TRACKNAMES_ja: Record<string, string> = {};
Object.keys(tracknames).forEach(k => TRACKNAMES_ja[k] = tracknames[k as keyof typeof tracknames][0]);
Object.freeze(TRACKNAMES_ja);

export const TRACKNAMES_en: Record<string, string> = {};
Object.keys(tracknames).forEach(k => TRACKNAMES_en[k] = tracknames[k as keyof typeof tracknames][1]);
Object.freeze(TRACKNAMES_en);

export function extendStrings(o: any, e: any) {
